            ...
            if ($mail_check == 1) {
                ...
                $seconddb->insert("password_reset", array(
                 ...
                 echo "
                    ...
                    font-size: 14px;
                    border-radius: 10px;'>We have sent a reset code to your mail.</div>
                ";

                ini_set( 'display_errors', 1 );
                error_reporting( E_ALL );
                $from = "info@ec-apo.com";
                $to = $email;
                ...
                background-color: orange;
                font-size: 14px;
                border-radius: 10px;'>Account was not found!</div>
            ";
            }
        }
...
<form id="password_check_form" method="post">
  ...
  <div class="container signin">
    <p>新規登録しますか？<a href="/register">登録</a>.</p><br>
    <p>既に登録済みですか <a href="/register">ログイン</a>.</p>
  </div>
