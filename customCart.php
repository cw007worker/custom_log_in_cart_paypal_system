...
<div class="container mt-5 mb-5">
  <div class="row">
    <div class="col-md-8" style="box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;">
      <?php 
    foreach($_SESSION['ec_apo_cart'] as $key => $val){ ?>
      ...
      <div class="d-flex justify-content-center row">
        ...
        if(isset($_SESSION['ec_apo_cart'])){
            ...
            <hr>
            <a href="/search.php" class="btn btn-danger btn-sm" style="width: 100%;margin-bottom: 30px;">Continue
              choosing
              services</a>
            <?php }
        }
    ...
    <div class="col-md-4" style="box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;">
      ...
      <h2 style="padding: 20px 0; color: red; font-size: 20px"><?php echo "合計: " .  $total; ?></h2>
      <p>商材は後程入力
      </p>
      <div class="row" style="padding-top: 20px">
        <div class="col text-center">
          <a href="/products" class="btn btn-sm btn-primary">アポ依頼へ進む<?php echo "(" . $count . "社)" ;  ?></a>
        </div>
      </div>
      <?php } ?>
    </div>
...
<div class="container">
  ...
  <hr>
  <a href="/search.php" class="btn btn-danger btn-sm" style="width: 100%;margin-bottom: 30px;">Continue choosing
    services</a>
</div>
<?php } ?>
...
$sql = "SELECT * FROM userlist WHERE company LIKE '%$company%' AND listflag = 'on' LIMIT 3";
