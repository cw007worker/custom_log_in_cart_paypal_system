...
<div class="container">
  ...
  <div class="row">
    ...
    line-height: 37px;">
        ...
        <form action="/products/?product-update=1" method="get">
    ...
    line-height: 37px;">
        ...
        <form action="/products/?product-update=2" method="get">
          <div class="form-group">
    ...
    line-height: 37px;">
        ...
        <form action="/products/?product-update=3" method="get">
          <div class="form-group">
